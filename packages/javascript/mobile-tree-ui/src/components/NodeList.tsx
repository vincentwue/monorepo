...
export const NodeList = ({
  ...
  const childCountFor = getChildCount ?? (() => 0);
  const allowReorder = typeof onReorder === "function";
  ...
  const beginDrag = (id: string) => (event: ReactPointerEvent<HTMLDivElement>) => {
              ...
              >
                <div className="mtu-node-list__body">
                  ...
                  <div className="mtu-node-list__actions">
                    <span className="mtu-node-list__badge">{childCountFor(node.id)}</span>
                    <button
                      type="button"
